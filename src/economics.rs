...
impl RewardCalculator {
    ...
    pub fn calculate_mining_reward(&self, _tx: &Transaction, tx_difficulty: u64) -> TokenAmount {
        ...
        let difficulty_factor = (tx_difficulty as f64 / self.min_mining_difficulty as f64).min(5.0); // Cap at 5x multiplier

        let reward =
            (base_reward as f64 * self.difficulty_multiplier * difficulty_factor) as TokenAmount;
