...
pub const FAUCET_SECRET_KEY: &str = "fa5979dd7273d55c6b5f2028ab166dc3163f90ac9f68da28b79a1fe0f06c45b8";

/// Faucet public key hex
pub const FAUCET_PUBLIC_KEY: &str = "5579ae9096f1ae55bfd6fd88155fad09c59ab8ccb61c8a297b5d1027ea4ca916";
...
pub fn initialize_genesis(config: GenesisConfig) -> (DAG, VQVConsensus, HashMap<String, u64>, HashMap<[u8; 32], Transaction>, Vec<Vec<u8>>) {
    let mut dag = DAG::new();
    ...
    let validators: Vec<Validator> = config.initial_validators.iter().map(|addr| {
        let mut pk = [0u8; 32];
